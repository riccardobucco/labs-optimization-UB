...
plt.savefig('../Images/01-gradient-descent-2nd-experiment-alpha-1.png')

INTERVAL_START_X1 = -50
INTERVAL_STOP_X1 = 50
...
# Apply the gradient method to the function starting at the specified point
x0 = STARTING_POINT
points = gradientDescent(x0, ALPHA, myFunction, myFunctionGradient, ITERATIONS)
