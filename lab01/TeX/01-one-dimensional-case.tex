\section{One dimensional case}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{../Images/01-one-dimensional-function.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{../Images/01-one-dimensional-function-with-extrema.png}
